...
public class TestListener extends TestListenerAdapter {
	...
	public void onTestFailure(ITestResult result) {
		...
		if (Driver.driver != null) {
			String imagePath = ".." + fileSeperator + "Screenshots"+ fileSeperator + "Results" + fileSeperator + testClassName+ fileSeperator
					+ takeScreenShot(Driver.driver, screenShotName, testClassName);
